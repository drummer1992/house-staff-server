...
const updateProductsStock = async (items: OrderItemInput[]): Promise<void> => {
...
const calculatePrice = (productsMap: Record<string, any>, order: OrderInput) => {
...
export default async (order: OrderInput, user?: User): Promise<string> => {
